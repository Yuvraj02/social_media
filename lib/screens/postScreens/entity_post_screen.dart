...
class EntityPosts extends StatefulWidget {
  const EntityPosts({Key? key}) : super(key: key);

  @override
  State<EntityPosts> createState() => _EntityPostsState();
}

class _EntityPostsState extends State<EntityPosts> {
  Uint8List? _file;
        ...
        children: [
          ...
          Padding(
            ...
            child: Align(
                ...
                child: isPosting ? CircularProgressIndicator(): IconButton(
                    onPressed: ()async{
                      setState(() {
                        isPosting = true;
                      });
                     await provider.uploadVerifiedPost(
